...
migrate((app) => {
  const snapshot = [
    ...
    },
    {
      ...
      "id": "pbc_3549173383",
      "indexes": [
        "CREATE UNIQUE INDEX `idx_tokenKey_pbc_3549173383` ON `agents` (`tokenKey`)",
        "CREATE UNIQUE INDEX `idx_email_pbc_3549173383` ON `agents` (`email`) WHERE `email` != ''"
      ],
    ...
    {
      "createRule": "@request.auth.collectionName = \"agents\" || @request.auth.collectionName = \"customers\"",
      "deleteRule": null,
      "fields": [
        {
          "autogeneratePattern": "[a-z0-9]{15}",
    ...
    },
    {
      ...
      "id": "pbc_1751747783",
      "indexes": [
        "CREATE UNIQUE INDEX `idx_SpwWXH2lNc` ON `customers` (`email`)",
